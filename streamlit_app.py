...
options = {
    'webdav_hostname': "https://bonneviedisk.quickconnect.to:5006",
    'webdav_login':    "BONNEVIE",
    'webdav_password': "pc0012pc"
}

client = Client(options)

# Gem lokalt først (Streamlit → temp fil)
temp_file = "/tmp/output.xlsx"
workbook.save(temp_file)

# Upload til NAS-mapppen
client.upload_sync(remote_path="/booking/output.xlsx", local_path=temp_file)
